			...
			<div class="row">
				<div class="col col-12">
					<ul class="nav nav-tabs justify-content-center">
	                    ...
	                    <li class="nav-item"><a href="#aba1"
							class="nav-link">Gerenciamento de Produtos</a></li>
	
	                    <li class="nav-item"><a href="#aba2"
							class="nav-link">Relatório de Vendas</a></li>
	
	                    <li class="nav-item navbar-right"><a
							href="#aba3" class="nav-link">Admin</a></li>
	                </ul>
	                   
                   <br />
	                   
                   <!-- ********** INÍCIO DO BODY DAS ABAS PRINCIPAIS ********** -->
                   <div class="tab-content">
                       
                       <!-- ********** BODY DA ABA 1********** -->
                       <div id="aba1" class="tab-pane" role="tabpanel">
						
						<!-- ********** LINHA PARA CONSULTA POR NOME, CÓDIGO, MARCA OU LOTE DO PRODUTO ********** -->
						<div class="form-group row">
                            ...
                            <div class="col-8">
                            	<input class="form-control"
									id="consProduto" placeholder="Digite o que está procurando :)">
                            </div>
                         ...
                         <!-- ********** LINHA PARA CONSULTA POR DATA INICIAL DE VALIDADE E DATA FINAL DE VALIDADE, ASSIM TRAZENDO UM RANGE ********** -->
                         <div class="form-group row">
                       		<div class="col-6">
								<div class="input-group date" data-provide="datepicker">
									<input class="form-control" size="8" type="text"
										id="inpDataInicial" placeholder="Digite a data inicial">
									<div class="input-group-btn">
										<button type="button" onclick="limpar('inpDataInicial')"
                            ...
                            <div class="col-6">
                            	<div class="input-group date"
									...
									<input class="form-control" size="8" type="text"
										id="inpDataFinal" placeholder="Digite a data inicial">
									<div class="input-group-btn">
										<button type="button" onclick="limpar('inpDataFinal')"
											class="btn btn-danger">
											<i class="fa fa-times-circle" aria-hidden="true"></i>
										</button>
										<button type="button" id="btnDtInicial"
						...
						<!-- ********** LINHA QUE ADICIONA O BOTÃO QUE CHAMA O MODAL ********** -->
						...
						<!-- ********** CORPO DO MODAL ********** -->
                                               ...
                                               <div class="col-md-12">
                                               	<div class="col-md-6">
													...
													class="form-horizontal">
                                                           ...
                                                           <label
														for="nomeProd" class="control-label col-md-4">Nome Produto:</label>
                                                           <div
														class="col-md-8">
                                                               <input
															class="form-control input-block-level" size="8"
															type="text" id="nomeProd" disabled>
                                                           </div>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-horizontal">
                                                           ...
                                                           <label
														for="precoProd" class="control-label col-md-4">Preço Unitário:</label>
                                                           <div
														class="col-md-8">
                                                               <input
															class="form-control" size="8" type="text"
															id="precoProd" disabled>
                                                           </div>
                                                    </div>
												</div>
                                               </div>
                       	...
                       	<!-- ********** LINHA QUE MOSTRARÁ O RESULTADO DA CONSULTA ********** -->
                       	<div class="row">
                       		<div class="col-md-12">
                                    ...
                                    <table class="table table-bordered table-striped table-hover"> <!-- table-striped table-bordered table-condensed -->
                                        <thead class="dark-primary-color">
                                            <tr class="active">
                                                ...
                                                <th class="text-center text-white">Nº do Lote</th>
                       	...
                       	<!-- ********** FIM DA LINHA QUE CONTEM A TABELA DE CONSULTA ********** -->
					</div>
					<!-- ********** FIM DO BODY DA ABA 1 ********** -->
                </div>
